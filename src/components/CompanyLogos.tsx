    ...
    <section className="py-12 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600">
          More than 3,500 companies in 2024 have posted job vacancies and internship positions with us, and the numbers are increasing daily.
        </p>
        <p className="text-center text-gray-600 mb-12">
          We are committed to continuously developing the system to provide the best user experience for all our users.
        </p>
