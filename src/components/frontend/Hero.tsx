        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Dekend: The website for finding internships and fresh graduate jobs in Thailand.<br/>
              Comes with an AI system to match jobs to your profile.
            </p>
            ...
            <div className="flex w-full max-w-xl mb-6 bg-white rounded-full overflow-hidden border border-gray-200">
              <input
                type="text"
                placeholder="e.g., Programmer, Accountant"
            ...
            <div className="flex flex-wrap gap-2 mb-12">
              {['Internships', 'Jobs', 'Part-time Jobs', 'Intern Students', 'Online Interviews', 'Work from Home'].map((tag) => (
                <span 
                  key={tag} 
            ...
            <div className="border-t pt-8">
              ...
              <p className="text-gray-600 mb-6">
                Job seekers/students can sign up for free to create their resume and find internships here.
              </p>
