...
export default function Navbar() {
    const [isLoggedIn, setIsLoggedIn] = useState(false) //Create "state" to store the logged in status
    const [isDropdownOpen, setIsDropdownOpen] = useState(false) //Create "state" to store the dropdown open status
    const [user, setUser] = useState<User | null>(null) //Create "state" to store the user data
