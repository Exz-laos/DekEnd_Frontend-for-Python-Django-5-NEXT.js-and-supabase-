  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-lg font-medium mb-1 text-gray-900">Profile picture</h2>
        <div className="text-center mb-6">
          <p className="text-gray-500 text-sm">Total points: <span className="text-orange-500 font-medium">0/100</span></p>
        </div>
