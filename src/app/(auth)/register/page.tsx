...
export default function Login() {
  ...
  const [showConfirmPassword, setShowConfirmPassword] = useState(false)
   ...
   // สร้างตัวแปรไว้ผูกกับฟอร์ม-Create variables to bind to forms
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Registration for students, job seekers and job posting companies
            </p>
          </div>
            ...
            <div className="mt-6 flex flex-col gap-4">
              ...
              >
                <Image
                  ...
                  height={24}
                />
                <span className="flex-1 text-left">Register with LINE</span>
              </button>
              <button
                type="button"
                className="w-full flex items-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-gray-900 hover:bg-gray-50 transition-colors"
              >
                <Image
                  ...
                  height={24}
                />
                <span className="flex-1 text-left">Register with GOOGLE</span>
              </button>
            </div>
